...
export const dataSource = new DataSource({
  ...
  synchronize: true,
  migrations: [
    CreateCousersTable1694481402905,
    CreateTagsTable1694481794483,
    CreateCoursesTagsTable1694482963650,
    AddCoursesIdToTagsTable1694483375227,
    AddTagsIdToCoursesTable1694483836686,
  ],
});
